...
resource "aws_launch_configuration" "petclinic_lc" {
  ...
  security_groups             = [data.terraform_remote_state.admin.outputs.petclinic_sg_asg]
...
resource "aws_cloudwatch_metric_alarm" "blue_cpu_greater_than_80" {
...
resource "aws_cloudwatch_metric_alarm" "blue_cpu_less_than_20" {
